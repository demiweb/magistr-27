$(document).ready(function () {
    $("#rec103687338").attr('data-animationappear', 'off');
    $("#rec103687338").css('opacity', '1');
    t451_initMenu('103687338');
});
$(document).ready(function () {
setTimeout(function () {
t_menusub_init('103687338');
}, 500);
});
$(document).ready(function () {
    setTimeout(function () {
        t825_initPopup('104512428');
    }, 500);
});
$(document).ready(function () {
});
...
$(document).ready(function () {
    setTimeout(function () {
        t702_initPopup('104386614');
    }, 500); /* hack for Android */
    var ua = navigator.userAgent.toLowerCase();
    var isAndroid = ua.indexOf("android") > -1;
    if (isAndroid) {
        $('.body').addClass('t-body_scrollable-hack-for-android');
...
$(document).ready(function () {
    t_sldsInit('105130898');
});
$(document).ready(function () {
    $('.t726').bind('displayChanged', function () {
        t_slds_updateSlider('105130898');
    });
});
...
$(document).ready(function () {
    t_reviews_social_init('105130898');
});
$(document).ready(function () {
